# 09G~09G_THRESHOLD_SENSITIVITY_ANALYSIS_FINAL_V1.R ----
#
# ============================================================
# 09G_THRESHOLD_SENSITIVITY_ANALYSIS_FINAL_V1.R
# ============================================================
# 09G：Threshold sensitivity analysis
#
# 输入：
#   自动从 03_tables 中寻找包含 ideal-like / safety-risk 连续 score 的主 group-level table。
#   首选来源通常来自 05B / 07A / 09B 的 full/master tables。
#
# 目的：
#   回答审稿人可能会问的问题：
#     “ideal-like / safety-risk 的 cutoff 是不是随便选的？”
#
# 做法：
#   1. 自动定位含有 ideal/projection score 和 safety-risk score 的 group-level table。
#   2. 在多个 quantile threshold 设置下重新分类：
#        ideal-like:
#          ideal_score >= ideal_high_threshold
#          AND safety_score <= safety_low_threshold
#
#        safety-risk-like:
#          safety_score >= safety_high_threshold
#
#        others:
#          lower-priority / mixed
#
#   3. 评估：
#        - class fractions 是否稳定
#        - dataset priority ranking 是否稳定
#        - 每个 group 的 class 是否稳定
#        - 如果存在原始 baseline label，则比较 baseline label 与 sensitivity label
#
# 注意：
#   09G 不改变 05B/09C/09E 的 final labels。
#   09G 是 robustness / sensitivity analysis。
#
# 输出：
#   D:/PD_Graft_Project/03_tables/09G_threshold_sensitivity_analysis_V1/
#   D:/PD_Graft_Project/04_figures/09G_threshold_sensitivity_analysis_V1_pdf/
#
# 成功标志：
#   ✅ 09G threshold sensitivity analysis FINAL V1 完成。
# ============================================================
...
# 5 个主 sensitivity settings：用于主图
...
# ============================================================
# 4. 自动定位 threshold sensitivity 输入表
# ============================================================
...
# Remove duplicated baseline_like/full if same values, keep both only if setting_id differs; acceptable.
...
# ============================================================
# 8. Class fractions and dataset priority
# ============================================================
...
# Add baseline class if available
...
# Figure 1: class fraction sensitivity heatmap
...
# Figure 2: dataset priority index by setting
...
# Figure 3: dataset rank stability heatmap
...
# Figure 4: group classification stability
...
# Figure 6: threshold value summary
...
# ============================================================
# 12. Key findings / method note / report
# ============================================================
