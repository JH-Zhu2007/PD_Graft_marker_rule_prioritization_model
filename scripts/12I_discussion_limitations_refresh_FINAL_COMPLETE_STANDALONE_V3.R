...
# ============================================================
# 12I FINAL COMPLETE STANDALONE V3 - D1_CLAIM_BOUNDARY_REPAIR
# Discussion / limitations refresh for DA neuron / graft-related
# transcriptomic cell-state prioritisation framework
#
# User rule respected:
#   - Complete standalone script for 12I
#   - Does NOT read any previous 12I output
#   - Does NOT patch old 12I tables or figures
#   - May read locked upstream outputs as formal inputs:
#       10A-10P, 11A-11J, 12A, 12B, 12C, 12D, 12E, 12F, 12G, 12H
#   - Uses 12H V4 Results text + 12H handoff as formal input
#   - Generates Discussion text, limitations, claim-boundary audit,
#     journal-positioning note, and 12J methods/reproducibility handoff
#   - No internet
#   - No 00-10P rerun
#
# Scientific boundary:
#   - Discussion/limitations generation only
...
# Hard rule: do not read previous 12I output
...
# ------------------------- read locked 12H and optional upstream inputs -------------------------
...
# ------------------------- 12J methods/reproducibility handoff -------------------------
