############################################################
# 10M_advanced_figure_plan_V2_COMPLETE_STANDALONE.R
# Project: PD_Graft_Project
# Purpose:
#   Build the advanced V2 figure/storyline plan after adding:
#     10G dataset-domain/project reframing audit
#     10H dataset role/model scope freeze
#     10I pseudotime input readiness audit
#     10J D8-only pseudotime pilot
#     10K multi-timepoint pseudotime trajectory
#     10L user scRNA signature-priority inference demo
#
# Important:
#   - This script DOES NOT rerun analysis.
#   - This script DOES NOT generate figures.
#   - It writes planning tables/text for the next module:
#       10N_advanced_manuscript_storyline_V2
#
# Final locks expected before this script:
...
# ------------------------------------------------------------------
# 1) Scan current project outputs for relevant final modules
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 2) Helper: locate representative source figures by filename keywords
# ------------------------------------------------------------------
...
# Candidate final source paths. These are not hard requirements; missing ones are marked NA.
src <- list(
...
# Figure 1: atlas and scoring framework
...
# Figure 2: prioritization evidence and differential expression
...
# Figure 4: ML model audit and generalization
...
# Figure 6: new 10K trajectory main evidence
...
# Figure 7: 10K trajectory-linked programs
...
# Figure 9: disease-context validation
...
# ------------------------------------------------------------------
# 4) Supplementary figure plan V2
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 5) Module integration decision table
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 7) Old-to-new figure reference scaffold
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# 8) Claim boundary and wording bank
# ------------------------------------------------------------------
claim_boundary <- c(
