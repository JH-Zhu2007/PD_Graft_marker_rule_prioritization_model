...
# ============================================================
# Purpose:
#   Generate publication-level figure legends and manuscript reference maps
#   after 10D V17 / 10E V2_FAST passed.
#
# This script DOES NOT:
#   - rerun analysis
#   - regenerate figures
#   - modify source PDFs
#   - modify the manuscript automatically
#
# This script DOES:
#   - read 10D V17 / 10E V2_FAST audit outputs
#   - create Figure 1–10 legends using the locked V17 storyline
#   - create Supplementary Figure 1–10 legend draft from final 10D panels
#   - create final main figure panel map
#   - create old-to-new figure reference map for 10G
#   - create action items for manual manuscript update
#
# Required:
...
#
# Output:
#   D:/PD_Graft_Project/09_manuscript/10F_figure_legends_and_reference_map_V1
#   D:/PD_Graft_Project/03_tables/10F_figure_legends_and_reference_map_V1
# ============================================================
...
# ============================================================
# 3. Load required 10D/10E tables
# ============================================================
...
# Add observed panel list from 10D for audit.
...
# ============================================================
# 5. Supplementary figure legend drafts
# ============================================================
...
# ============================================================
# 6. Old-to-new reference replacement map
# ============================================================

stamp("Writing old-to-new figure reference replacement map for 10G...")

# Old compact structure before V17:
#   Old Figure 1: F1A-F1E, but F1A workflow was removed.
#   Old Figure 2: F2A-F2E.
#   Old Figure 3: F3A-F3E.
#   Old Figure 4: F4A-F4E.
#   Old Figure 5: F5A-F5E.
#
# New V17 structure:
#   Figure 1: F1B/F1C/F1D
#   Figure 2: F1E/F2A
#   Figure 3: F2B
#   Figure 4: F2C/F2D/F2E
#   Figure 5: F3A/F3B/F3C
#   Figure 6: F3D/F3E
#   Figure 7: F4A/F4B
#   Figure 8: F4C/F4D/F4E
#   Figure 9: F5A/F5B
#   Figure 10: F5C/F5D/F5E
...
# Add current title where possible.
