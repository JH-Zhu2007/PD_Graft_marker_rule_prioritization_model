# 10A~10A_FINAL_MANUSCRIPT_FIGURE_PANEL_ASSEMBLY_V1.R ----
#
# ============================================================
# 10A_FINAL_MANUSCRIPT_FIGURE_PANEL_ASSEMBLY_V1.R
# ============================================================
# 10A：Final manuscript figure panel assembly
#
# 目的：
#   把前面 00–09J 的核心结果组织成“投稿论文主图/补图布局”。
#
# 10A 不重新做生物学分析，不修改任何 frozen framework。
# 10A 只做：
#   1. manuscript figure plan
#   2. final story flow diagram
#   3. main evidence summary panel
#   4. robustness + validation summary figure
#   5. claim-boundary / limitation-aware summary
#   6. final figure manifest for 10B manuscript writing
#
# 输入优先级：
#   09J final = V2_PUBLICATION_LAYOUT
#   如果 09J V2 还没跑通，则自动 fallback 到 09J V1。
#
# 输出：
#   D:/PD_Graft_Project/03_tables/10A_final_manuscript_figure_panel_V1/
#   D:/PD_Graft_Project/04_figures/10A_final_manuscript_figure_panel_V1_pdf/
#
# 成功标志：
#   ✅ 10A final manuscript figure panel assembly V1 完成。
# ============================================================
...
# Figure 10A-1 Story flow diagram
...
# Figure 10A-2 Main evidence summary
evidence_rows <- c(
...
# Figure 10A-3 External validation + robustness
val_dt <- data.table(
  layer = c(
    "Threshold\nsensitivity",
    "Negative-control\npositive delta-AUC",
...
# Figure 10A-5 Figure manifest panel
...
# ============================================================
# 9. 文本输出：results / captions / method note
# ============================================================
