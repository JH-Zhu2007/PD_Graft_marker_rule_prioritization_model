# 09F~09F_EXTERNAL_VALIDATION_FIGURE_POLISH_FINAL_V3_PUBLICATION_LAYOUT.R ----
#
# ============================================================
# 09F_EXTERNAL_VALIDATION_FIGURE_POLISH_FINAL_V3_PUBLICATION_LAYOUT.R
# ============================================================
# 09F：External validation figure polish
#
# 输入：
#   09E final = V6_FIX_CLUSTER_CELLID
#
# V3 目的：
#   V2 已经成功生成 09F 图，但部分图文字拥挤：
#     - predictor probability 图 y 轴标签太长、太密
#     - priority scatter 里 cluster 标签挤在左上角
#     - heatmap x 轴文字较密
#
#   V3 不重新分析，不改模型，不改 marker，不改 threshold。
#   V3 只做 publication layout polish：
#     1. cluster size：增加 n label，留白更合理
#     2. heatmap：更大画布、短标签、字体缩小、cluster/order 更清楚
#     3. probability：改成 compact grouped plot，避免 32 行长标签
#     4. priority：增加 priority index barplot，替代拥挤 scatter 作为推荐图
#     5. scatter：用 Random forest probabilities 做更分散的辅助 scatter；
#        logistic saturated result 用表格和 summary panel 表达
#     6. summary panel：纯 ggplot table，不用 patchwork/cowplot，避免 locked binding 错误
#
# 重要：
#   V3 只是图形排版增强，不改变 09E/09F 的科学结论。
#
# 输出：
#   D:/PD_Graft_Project/03_tables/09F_external_validation_figure_polish_V3_PUBLICATION_LAYOUT/
#   D:/PD_Graft_Project/04_figures/09F_external_validation_figure_polish_V3_PUBLICATION_LAYOUT_pdf/
#
# 成功标志：
#   ✅ 09F external validation figure polish FINAL V3 PUBLICATION LAYOUT 完成。
# ============================================================
...
# Add selected top marker-score category per cluster
...
# ============================================================
# 6. Figure 1：external cluster size
# ============================================================
...
# ============================================================
# 7. Figure 2：signature score heatmap
# ============================================================
...
# Column-wise z-score for display only.
if (nrow(heat_mat) > 1) {
...
# Order clusters by consensus priority if available, otherwise cell size
...
# ============================================================
# 8. Figure 3：predictor probability compact
# ============================================================
...
# ============================================================
# 9. Figure 4：priority index barplot
# ============================================================
...
# ============================================================
# 10. Figure 5：Random forest scatter
# ============================================================
...
# ============================================================
# 11. Figure 6：gene overlap polished
# ============================================================
...
# ============================================================
# 13. Method note / figure manifest / report
# ============================================================
