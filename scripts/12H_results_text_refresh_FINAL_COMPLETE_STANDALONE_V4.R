...
# ============================================================
# 12H FINAL COMPLETE STANDALONE V4 - CLAIM_BOUNDARY_FULL_PASS
# Results text refresh for DA neuron / graft-related
# transcriptomic cell-state prioritisation framework
#
# User rule respected:
#   - Complete standalone script for 12H
#   - Does NOT read any previous 12H output
#   - Does NOT patch old 12H tables or figures
#   - May read locked upstream outputs as formal inputs:
#       10A-10P, 11A-11J, 12A, 12B, 12C, 12D, 12E, 12F, 12G
#   - Uses 12G legends/captions + 12G handoff as formal input
#   - Generates Results text, figure callouts, claim-boundary audit,
#     and 12I discussion/limitations handoff
#   - No internet
#   - No 00-10P rerun
#
# Scientific boundary:
#   - Results-text generation only
...
# Hard rule: do not read previous 12H output
...
# ------------------------- read locked 12G and optional upstream summaries -------------------------
...
# V3 audit rule:
#   - flags only affirmative overclaiming patterns, not negated boundary language
#   - requires each Results section to contain conservative computational/hypothesis-generating/candidate wording
...
# FigB Results section to figure map
...
# FigC Results claim boundary audit
...
# FigE final manuscript text output map
