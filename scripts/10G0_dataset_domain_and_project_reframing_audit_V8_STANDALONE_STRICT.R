# ============================================================
# 10G0 V8 STANDALONE STRICT
# Dataset-domain + model-input + project-reframing audit
# Project: Dopaminergic neuron / dopaminergic graft cell-state prioritization
# Author: ChatGPT-assisted pipeline
# Notes:
#   - Fully standalone: does NOT read V4/V5/V6/V7 outputs.
#   - Strict GSE parser: only keeps GSE accessions with 5-7 digits.
#   - Avoids false positives such as GSE184 / GSE243 from GEO path folders.
#   - Does NOT modify old 10D/10E/10F outputs.
# ============================================================
...
# Folders to scan. These are output/manuscript/model/figure folders, not raw big matrices.
SCAN_FOLDERS <- c(
...
# Content scan limits to avoid RStudio memory crash on Windows.
...
# Strict GSE extraction: avoids GSE184 / GSE243 false positives.
...
# Prefer small and highly informative files.
...
# Extra hard remove of short false positives if somehow present.
...
# Fill defaults for additional detected accessions.
