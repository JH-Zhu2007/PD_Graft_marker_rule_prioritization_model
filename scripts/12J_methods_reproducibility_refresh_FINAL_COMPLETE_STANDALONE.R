...
# ============================================================
# 12J FINAL COMPLETE STANDALONE
# Methods / reproducibility refresh for DA neuron / graft-related
# transcriptomic cell-state prioritisation framework
#
# User rule respected:
#   - Complete standalone script for 12J
#   - Does NOT read any previous 12J output
#   - Does NOT patch old 12J tables or figures
#   - May read locked upstream outputs as formal inputs:
#       10A-10P, 11A-11J, 12A, 12B, 12C, 12D, 12E, 12F, 12G, 12H, 12I
#   - Uses 12I V3 discussion/limitations handoff as formal input
#   - Generates Methods text, reproducibility checklist, locked module
#     provenance, claim-boundary controls, and 12K GitHub handoff
#   - No internet
#   - No 00-10P rerun
#
# Scientific boundary:
#   - Methods/reproducibility documentation only
...
# Hard rule: do not read previous 12J output
...
# ------------------------- figure/table source reproducibility -------------------------
