# ============================================================
# 09J_ROBUSTNESS_INTEGRATION_REPORT_FINAL_V2_PUBLICATION_LAYOUT_RESTORED.R
# ============================================================
# PD_Graft_Project — 09J restored script
#
# 09J：Robustness / external-validation integration report
#
# 本脚本用途：
#   把 09D–09I 的最终结果整合成投稿前可读的总表、总图和 claim-boundary 报告。
#
# 输入模块：
#   09D final = V8_PUBLICATION_POLISH
#   09E final = V6_FIX_CLUSTER_CELLID
#   09F final = V3_PUBLICATION_LAYOUT
#   09G final = V1
#   09H final = V1
#   09I final = V9_CHECKPOINT_RESUME_SAFE_FIGURES
#
# 09J 不做新生物学分析，不改 frozen marker/scoring/ML framework。
# 只做 integration / reporting / claim-boundary summary。
#
# 输出：
#   D:/PD_Graft_Project/03_tables/09J_robustness_integration_report_V2_PUBLICATION_LAYOUT/
#   D:/PD_Graft_Project/04_figures/09J_robustness_integration_report_V2_PUBLICATION_LAYOUT_pdf/
#   D:/PD_Graft_Project/06_reports/09J_robustness_integration_report.txt
#
# 成功标志：
#   ✅ 09J robustness integration report FINAL V2 PUBLICATION LAYOUT 完成。
# ============================================================
...
# ============================================================
# 5. Input file audit / module status
# ============================================================
...
# ============================================================
# 6. External validation summary
# ============================================================

stamp("整合 09E/09F/09I external validation summaries。")

# 09E / 09F known outputs, with final fallback values
...
# 09I key findings, with final fallback values
...
# ============================================================
# 8. Claim boundary / evidence map / editor summary
# ============================================================
