...
# ============================================================
# 12L FINAL COMPLETE STANDALONE V2 - ABSTRACT_BOUNDARY_REPAIR
# Journal / cover-letter refresh for DA neuron / graft-related
# transcriptomic cell-state prioritisation framework
#
# User rule respected:
#   - Complete standalone script for 12L
#   - Does NOT read any previous 12L output
#   - Does NOT patch old 12L tables or figures
#   - May read locked upstream outputs as formal inputs:
#       10A-10P, 11A-11J, 12A, 12B, 12C, 12D, 12E, 12F, 12G,
#       12H, 12I, 12J and 12K
#   - Uses 12K V2 GitHub/repository handoff as formal input
#   - Generates journal-positioning plan, cover-letter draft blocks,
#     title/abstract positioning, submission strategy, editor-facing
#     claim-boundary checklist, and 12M submission-package handoff
#   - No internet
#   - No 00-10P rerun
#
# Scientific boundary:
#   - Journal/submission-positioning documentation only
...
#
# Important:
#   - This module does not use live journal metrics, current impact factors,
#     APCs or journal policy pages because it is offline by design.
#   - Before real submission, journal scope, formatting, article type,
#     APC/open-access rules and data/code policy must be checked manually
#     on each journal website.
# ============================================================
...
# Hard rule: do not read previous 12L output
...
# ------------------------- read locked 12K and upstream text inputs -------------------------
...
# ------------------------- title and abstract positioning -------------------------
...
# ------------------------- editor-facing claim-boundary checklist -------------------------
...
# ------------------------- claim-boundary audit for 12L text -------------------------
...
# FigB journal positioning tiers
...
# FigD cover letter claim-boundary audit
...
# FigE 12M submission-package handoff
